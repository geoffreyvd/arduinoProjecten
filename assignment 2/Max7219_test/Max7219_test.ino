...
void spaceInvader1()
{
  maxSingle(1, ___xx___);
  maxSingle(2, _xxxxxx_);
  maxSingle(3, x__xx__x);
  maxSingle(4, x__xx__x);
  maxSingle(5, _xxxxxx_);
  maxSingle(6, __x__x__);
  maxSingle(7, __x__x__);
  maxSingle(8, xxx__xxx);
}

void spaceInvader2()
{
  maxSingle(1, ________);
  maxSingle(2, __xxxx__);
  maxSingle(3, xxxxxxxx);
  maxSingle(4, x__xx__x);
  maxSingle(5, xxxxxxxx);
  maxSingle(6, __xxxx__);
  maxSingle(7, x_x__x_x);
  maxSingle(8, _xx__xx_);
}
